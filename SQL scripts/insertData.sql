...
-- trip table
INSERT INTO trip VALUES (NULL, '2022-11-01 07:00', '2023-03-31 18:00', 100, 239.00, 4, 'ΑΑ875155', 'ΑΤ512106'); 

-- destination table
INSERT INTO destination VALUES (NULL, "ΑΥΣΤΡΙΑ", "Η Αυστρία είναι περίκλειστη χώρα στο νότιο τμήμα της Κεντρικής Ευρώπης και βρίσκεται στις Ανατολικές Άλπεις.", "ABROAD", "Γερμανικά", NULL);
...
INSERT INTO destination VALUES (NULL, "Βιέννη", "Στη Βιέννη, η καφετέρια δεν είναι απλώς ένα μέρος για να συχνάζει κανείς—είναι θεσμός. Σύμφωνα με την UNESCO, η ανάγνωση εφημερίδας συνοδεία ενός αρτοσκευάσματος κι ενός δυνατού εσπρέσο είναι επισήμως ένα από τα βασικά συστατικά της βιενέζικης κουλτούρας. Κάψτε τις θερμίδες από τα ζαχερτόρτε με μια περιήγηση χωρίς ξεναγό στα εντυπωσιακά μνημεία της παραδοσιακής και μοντέρνας αρχιτεκτονικής, όπως το Αυτοκρατορικό Ανάκτορο, η Κρατική Όπερα, το παρεκκλήσι Kirche am Steinhof ή το Μουσείο Kunsthistorisches, το οποίο είναι μια σπουδή στην καλαισθησία και τη γεωμετρία.", "ABROAD", "Γερμανικά", 1);
INSERT INTO destination VALUES (NULL, "Σάλτσμπουργκ", "Έχουν περάσει περίπου 200 χρόνια από όταν έζησε εδώ, αλλά ο Μότσαρτ παραμένει το αγαπημένο παιδί του Σάλτσμπουργκ (Salzburg). Επισκεφθείτε το πατρικό και την κατοικία του συνθέτη και, στη συνέχεια, εξερευνήσετε την παλαιά πόλη (Altstadt) με τη μπαρόκ αρχιτεκτονική. Αν προτιμάτε τη τζαζ και το “My favorite things” με τον John Coltrane από την κλασική μουσική και το «Ρέκβιεμ σε ντο ελάσσονα», δηλώστε συμμετοχή σε μια από τις οργανωμένες περιηγήσεις στα αξιοθέατα και στα μέρη που απολαύσαμε όλοι στη «Μελωδία της ευτυχίας» («Sound of music», η γνωστή ταινία του 1965, με τους Julie Andrews και Christopher Plummer) και ακολουθήστε τα βήματα της Μαρίας και της οικογένειας του πλοιάρχου von Trapp.", "ABROAD", "Γερμανικά", 1);
INSERT INTO destination VALUES (NULL, "Ίνσμπρουκ", "Αντικείμενο πόθου από αυτοκρατορίες και δημοκρατίες σε ολόκληρη την πορεία της ιστορίας του, το Ίνσμπρουκ υπήρξε η έδρα της αυτοκρατορικής αυλής του Μαξιμιλιανού I έως τα τέλη του 15ου αιώνα. Μπορείτε να μετακινηθείτε στην πόλη εύκολα, αποτελεσματικά και οικονομικά με το τραμ. Εξερευνήστε την ιστορία της τυρολέζικης πρωτεύουσας στο κάστρο Άμπρας (Schloss Ambras) του 10ου αιώνα, κατοικία του αρχιδούκα Φερδινάνδου II, στο τυρολέζικο μουσείο λαϊκής τέχνης, στο μεγαλοπρεπές αυτοκρατορικό ανάκτορο του 15ου αιώνα και στη φημισμένη χρυσή στέγη του Μαξιμιλιανού I. Μια από τις πιο ειδυλλιακές πόλης της Ευρώπης, το Ίνσμπρουκ είναι φωλιασμένο στην καρδιά των Άλπεων.", "ABROAD", "Γερμανικά", 1);
INSERT INTO destination VALUES (NULL, "Σίφελντ Ιν Τιρόλ", "Τον χειμώνα, το υπέροχο Σίφελντ Ιν Τιρόλ εκπέμπει την παραμυθένια ατμόσφαιρα ενός χριστουγεννιάτικου χωριού. Χτισμένο σε ένα οροπέδιο ανάμεσα σε βουνά και πεδιάδες, είναι το ιδανικό μέρος για αθλήματα χιονιού, ιδίως για σκι μεγάλων αποστάσεων. Μάλιστα, εδώ έχουν διεξαχθεί διάφοροι διαγωνισμοί στο πλαίσιο Ολυμπιακών Αγώνων και Παγκόσμιων Πρωταθλημάτων. Την περίοδο εκτός αιχμής, ο πεντακάθαρος βουνίσιος αέρας και η εντυπωσιακή θέα ανταμείβουν τους λάτρεις της πεζοπορίας. Όταν νιώσετε την ανάγκη να ανακτήσετε τις δυνάμεις σας, απολαύστε ένα γεύμα με σνίτσελ και μπύρα τοπικής παραγωγής σε ένα από τα γραφικά εστιατόρια της περιοχής.", "ABROAD", "Γερμανικά", 1);
INSERT INTO destination VALUES (NULL, "Κίτζμπιελ", "Ένα από τα πολυτελέστερα χιονοδρομικά θέρετρα της Αυστρίας, το γοητευτικό Κίτζμπιελ (Kitzbühel), γνωστό και ως «Κιτζ», βρίσκεται ανάμεσα στα όρη Hahnenkamm και Kitzbüheler Horn. Κάθε χειμώνα, η πλαγιά Streif του Hahnenkamm είναι μια από τις δυσκολότερες κατηφορικές πίστες των αγώνων για το παγκόσμιο κύπελλο σκι. Το καλοκαίρι, οι λάτρεις του τένις συρρέουν σε αυτή την τυρολέζικη πόλη για το Austrian Open. Οι φιδωτοί, λιθόστρωτοι μεσαιωνικοί δρόμοι είναι γεμάτοι με σπορ αυτοκίνητα και ακριβές μπουτίκ, καθώς οι διασημότητες της Ευρώπης κατηφορίζουν στις περιβόητες πλαγιές.", "ABROAD", "Γερμανικά", 1);
...
INSERT INTO destination VALUES (NULL, "Καλαμάτα", "Κάτω από τον επιβλητικό Ταΰγετο, στην αγκαλιά του Μεσσηνιακού κόλπου, η Καλαμάτα σάς καλεί να μπείτε στο ζωντανό ρυθμό της.", "LOCAL", "Ελληνικά", 2);
INSERT INTO destination VALUES (NULL, "Ιωάννινα", "Σε αυτή τη γωνιά της Ηπείρου, θα συναντήσετε μύθους αποτυπωμένους στην ιστορία της πόλης: στο Κάστρο, στην ακρόπολη του Ιτς Καλέ, στις βυζαντινές μονές και στα μουσεία. Αναπόσπαστο μέρος της ζωής των Ιωαννίνων. Θα τους βρείτε στα πάρκα, στους μικροεμπόρους της Ανεξαρτησίας, στους φοιτητές, στα δεκάδες στέκια, στα παραλίμνια καφέ, στα μπαράκια, στα εστιατόρια. Θα τους δείτε να προβάλλουν ανάγλυφοι στην τέχνη των φημισμένων αργυροχόων. Θα σας ακολουθήσουν μέχρι το σπήλαιο του Περάματος, τη Δωδώνη και τα Ζαγοροχώρια. Απολαύστε τις διακοπές σας στα Γιάννενα και αφήστε τον εαυτό σας ελεύθερο να τους αισθανθεί. Και αν το κάνετε, η υπέροχη αυτη πόλη της Ηπείρου θα σας μαγέψει.", "LOCAL", "Ελληνικά", 2);


-- travel_to table
INSERT INTO travel_to VALUES (1, 3, '2022-11-01 07:00', '2022-11-06 18:00');
INSERT INTO travel_to VALUES (1, 4, '2022-12-01 07:00', '2022-12-06 18:00');
INSERT INTO travel_to VALUES (1, 5, '2023-01-01 07:00', '2023-01-06 18:00');
INSERT INTO travel_to VALUES (1, 6, '2023-02-01 07:00', '2023-02-06 18:00');
INSERT INTO travel_to VALUES (1, 7, '2023-03-01 07:00', '2023-03-06 18:00');
INSERT INTO travel_to VALUES (1, 8, '2023-03-26 07:00', '2023-03-31 18:00');