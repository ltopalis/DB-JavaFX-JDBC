...
INSERT INTO destination VALUES(NULL, "Βενετία", "Η Βενετία είναι μια γοητευτική πόλη που μαγεύει τους επισκέπτες. Είναι ονειρική και ρομαντική με μια ιδέα μυστηρίου και δράματος.","ABROAD","Ιταλικά",NULL);
...
INSERT INTO destination VALUES(NULL, "Λονδίνο", "Η μεσαιωνική και βικτοριανή παράδοση του Λονδίνου συμπληρώνουν έναν πλούσιο και πολύβουο σύγχρονο κόσμο.","ABROAD","Αγγλικά",NULL);
INSERT INTO destination VALUES(NULL, "Ρώμη", "Η ατέλειωτη Ρώμη παραμένει μια από τις πιο σημαντικές πόλεις στον κόσμο, χάρη στον μοναδικό συνδυασμό του αρχαίου κόσμου και των σύγχρονων απολαύσεων.", "ABROAD", "Ιταλικά",7);
INSERT INTO destination VALUES(NULL, "Άμστερνταμ", "Από τα γραφικά κανάλια και τις γέφυρες μέχρι τις ιστορικές κατοικίες του, το Άμστερνταμ είναι μια πραγματικά παραμυθένια πόλη.", "ABROAD", "Ολλανδικά",NULL);
INSERT INTO destination VALUES(NULL, "Πράγα", "Σε οποιοδήποτε σημείο της Πράγας και αν βρεθείτε, σίγουρα θα αντικρίσετε κάποιο από τα εντυπωσιακά αξιοθέατα της ή ένα περίτεχνο οικοδόμημα, το οποίο θα σας ταξιδέψει στο παρελθόν. ","ABROAD", "Τσέχικα", NULL);
INSERT INTO destination VALUES(NULL, "Βερολίνο", "Μια κοσμοπολίτικη πόλη με χαρακτήρα.Από τη μόδα μέχρι την αρχιτεκτονική του και την πολιτική ιστορία του, το Βερολίνο ήταν πάντα προχωρημένο. ","ABROAD", "Γερμανικά", NULL);
...
INSERT INTO destination VALUES(NULL, "Λήμνος", "Χωριά-αριστουργήματα φτιαγμένα από πέτρα, κάστρα, αξιοθέατα, αρχαϊκά μυστήρια, αλλά και μοναδικά προϊόντα της ηφαιστειακής γης.","LOCAL","Ελληνικά",NULL);
INSERT INTO destination VALUES(NULL, "Σάμος","Σε αυτό το καταπράσινο νησί στην άκρη του Αιγαίου ανάμεσα σε πευκοδάση και ελαιώνες, σε εκτάσεις με εσπεριδοειδή και εύφορους αμπελώνες, θα ανακαλύψετε μύθους και ιστορικές αλήθειες.","LOCAL","Ελληνικά",NULL);
...
INSERT INTO destination VALUES(NULL, "Βαρκελώνη","Δεν υπάρχει άλλο μέρος στον κόσμο σαν τη Βαρκελώνη. Το πρωί βόλτες στη Γοτθική Συνοικία, το απόγευμα στην παραλία και τη νύχτα διασκέδαση μέχρι την αυγή. Η πόλη είναι σαγηνευτική.", "ABROAD", "Ισπανικά",8);
INSERT INTO destination VALUES(NULL, "Τρίκαλα", "Τα Τρίκαλα, πρωτεύουσα του ομώνυμου νομού, είναι μια όμορφη πόλη χτισμένη στη θέση της αρχαίας Τρίκκης (σύμφωνα με τη μυθολογία, η νύμφη Τρίκκη ήταν κόρη του Πηνειού) και πατρίδα του περίφημου γιατρού της αρχαιότητας, Ασκληπιού.", "LOCAL", "Ελληνικά", NULL);
...
INSERT INTO destination VALUES(NULL, "Ξάνθη", "Αμφιθεατρικά χτισμένη στους πρόποδες της οροσειράς της Ροδόπης, η Ξάνθη αποτελεί το στολίδι της Θράκης, του μοναδικού αυτού μέρους της Ελλάδας που συνδέει την Μαύρη Θάλασσα με το Αιγαίο και την Ευρώπη με την Ασία.", "LOCAL", "Ελληνικά", NULL);
INSERT INTO destination VALUES(NULL, "Ξάνθη", "Αμφιθεατρικά χτισμένη στους πρόποδες της οροσειράς της Ροδόπης, η Ξάνθη αποτελεί το στολίδι της Θράκης, του μοναδικού αυτού μέρους της Ελλάδας που συνδέει την Μαύρη Θάλασσα με το Αιγαίο και την Ευρώπη με την Ασία.", "LOCAL", "Ελληνικά", 6);
...
INSERT INTO travel_to VALUES(3, 4, "2022-12-26 09:30:00", "2022-12-24 16:15:00");
INSERT INTO travel_to VALUES(3, 5, "2022-12-27 17:45:00", "2022-12-24 06:16:00");
INSERT INTO travel_to VALUES(3, 21, "2022-12-27 21:40:00", "2022-12-24 17:51:00");
INSERT INTO travel_to VALUES(4, 6, "2023-03-09 18:12:00", "2022-12-26 22:30:00");
INSERT INTO travel_to VALUES(4, 7, "2023-03-09 19:20:00", "2022-12-26 22:30:00");
INSERT INTO travel_to VALUES(5, 8, "2023-06-13 18:56:00", "2023-06-10 16:40:00");
INSERT INTO travel_to VALUES(6, 9, "2023-05-15 21:40:00", "2023-05-10 15:16:00");
INSERT INTO travel_to VALUES(7, 10, "2023-05-15 23:40:00", "2023-05-10 18:10:00");
